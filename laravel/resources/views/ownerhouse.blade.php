 ...
 <body class="h-screen flex flex-col ubuntu-medium">
     ...
     <div class="h-12 bg-green-700">
         ...
         <button id="openDialogBtn"
             class="bg-green-800 text-white rounded-lg transition-all hover:scale-105 hover:opacity-85 shadow-xl w-48 mt-4 ml-4">Voeg
             vakantiehuis toe</button>
         <dialog id="simpleDialog" class="p-4 rounded-lg shadow-lg w-2/3 h-auto">
             ...
             <form action="/addhouse" method="POST" enctype="multipart/form-data" class="space-y-4">
                 ...
                 <div class="flex flex-wrap justify-center space-x-4">
                     <div class="flex flex-col items-center">
                         ...
                         <input type="text" id="house_name" name="house_name" required
                             class="p-2 border border-gray-300 rounded h-7 w-64">
                     </div>
                     <div class="flex flex-col items-center">
                         <label for="location_house" class="mb-1">Plaatsnaam huisje:</label>
                         <input type="text" id="location_house" name="house_location" required
                             class="p-2 border border-gray-300 rounded h-7 w-64">
                     </div>
                 </div>
                 <div class="flex flex-wrap justify-center space-x-4">
                     <div class="flex flex-col items-center">
                         ...
                         <input type="number" id="amount_people" name="amount_people" required
                             class="p-2 border border-gray-300 rounded h-7 w-64">
                     </div>
                     <div class="flex flex-col items-center">
                         <label for="amount_bedrooms" class="mb-1">Hoeveel slaapkamers:</label>
                         <input type="number" id="amount_bedrooms" name="amount_bedrooms" required
                             class="p-2 border border-gray-300 rounded h-7 w-64">
                     </div>
                 </div>
                 <div class="flex flex-wrap justify-center space-x-4">
                 ...
                 <div class="flex flex-col items-center">
                     ...
                     <textarea id="description_location" name="description_location" required class="p-2 border border-gray-300 rounded"
                         rows="4" cols="50"></textarea>
                 </div>
                 <div class="flex flex-col items-center">
                     <label for="description_house" class="mb-1">Omschrijving wat huisje bevat:</label>
                     <textarea id="description_house" name="description_house" required class="p-2 border border-gray-300 rounded"
                         rows="4" cols="50"></textarea>
                 </div>
                 <div class="flex flex-col items-center">
                 ...
                 <div class="flex justify-center">
                     <button type="submit"
                         class="bg-green-800 text-white rounded cursor-pointer transition-all hover:scale-105 hover:opacity-85 hover:bg-green-700 w-48 mt-4 ml-4">Verzend</button>
                     <button id="closeDialogBtn"
                         class="bg-green-800 text-white rounded cursor-pointer transition-all hover:scale-105 hover:opacity-85 hover:bg-green-700 w-48 mt-4 ml-4">Terug</button>
                 </div>
             </form>
         </dialog>
     </div>
     ...
     @foreach ($houses as $house)
         <div class="bg-green-700 w-3/4 m-3 h-40 mx-auto flex rounded-lg flex-col justify-between p-2">
             <div class="flex">
                 <img class="w-36 h-24 mr-3 rounded-lg" src="{{ asset('images/Voorthuizen/HouseV.png') }}"
                     alt="Voorthuizen">
                 <div class="flex justify-between items-start w-full">
                     <div class="flex flex-col">
                         ...
                         <h1 class="text-sm text-white p-1">
                             ...
                             <button id="openSecondDialogBtn" class="text-white underline focus:outline-none">bekijk
                                 hier</button>
                         </h1>
                     </div>
                     ...
                     <div class="flex flex-col space-y-2">
                         <button id="openEditDialogBtn"
                             class="bg-white text-green-800 rounded-lg transition-all hover:scale-105 hover:opacity-85 shadow-xl w-40">Bewerken</button>
                        <form action="{{ route('deletehouse') }}" method="POST">
                            @csrf
                            <input type="hidden" name="houseId" value="{{ $house->id }}"></input>
                             <input id="deleteBtn" type="submit" class="bg-white text-green-800 rounded-lg transition-all hover:scale-105 hover:opacity-85 shadow-xl w-40">Verwijderen</input>
                         </form>
                     </div>
                 </div>
             </div>
         ...
         <div class="flex justify-center items-center text-green-700 text-center">
             <form action="/addhouse" method="POST" enctype="multipart/form-data" class="space-y-4">
                 ...
                 <div class="flex justify-center">
                     <button type="submit"
                         class="bg-green-800 text-white rounded cursor-pointer transition-all hover:scale-105 hover:opacity-85 hover:bg-green-700 w-48 mt-4 ml-4">Verzend</button>
                     <button type="button" id="closeEditDialogBtn"
                         class="bg-green-800 text-white rounded cursor-pointer transition-all hover:scale-105 hover:opacity-85 hover:bg-green-700 w-48 mt-4 ml-4">Terug</button>
                 </div>
             </form>
     </dialog>
     ...
     <dialog id="secondDialog" class="p-4 rounded-lg shadow-lg w-2/3 h-96">
         <div class="flex flex-col items-center">
             <h1 class="text-mg text-green-800"> Huidige omschrijving omgeving huisje: <h2 class="text-sm">(incomming
                     tekst)</h4>
             </h1>
         </div>
         <br> <br>
         <div class="flex flex-col items-center">
             <h1 class="text-mg text-green-800"> Huidige omschrijving inhoud huisje: <h2 class="text-sm">(incomming
                     tekst)</h4>
             </h1>
         </div>
         <br> <br> <br> <br> <br> <br>
         <div class="flex justify-center">
             <button type="button" id="closeSecondDialogBtn"
                 class="bg-green-800 text-white rounded cursor-pointer transition-all hover:scale-105 hover:opacity-85 hover:bg-green-700 w-48 mt-4 ml-4">Sluiten</button>
         </div>
     </dialog>
     </div>
     </div>
