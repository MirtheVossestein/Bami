...
<body class="flex flex-col min-h-screen ubuntu-medium">
    <div class="relative h-72 bg-green-800 flex items-center justify-center ">
        ...
        <h2 class="ubuntu-regular-italic absolute left-4 top-44 z-20 text-white text-2xl ">Ontsnap naar de natuur,
            verblijf in een Bamihuisje</h2>
        <h2 class="ubuntu-regular absolute left-4 top-52 z-20 text-white text-4xl ">Jouw rustieke vakantiehuis!</h2>
        <a href="houses"
            class="absolute z-20 top-4 right-80 py-1 px-16 transition-all shadow-lg bg-white rounded-lg p-2 hover:scale-110 hover:opacity-85">
            <h1 class="text-sm">Vakantiehuizen</h1>
        </a>
        <a href="contactpage"
            class="absolute z-20 top-4 right-32 py-1 px-16 right-2 transition-all shadow-lg bg-white rounded-lg p-2 hover:scale-110 hover:opacity-85">
            <h1 class="text-sm">Contact</h1>
        </a>
        <div class=" z-20">
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                class="absolute z-20 top-4 py-1 transition-all px-6 right-6 shadow-lg bg-white rounded-lg p-2 transition-all hover:scale-105 hover:opacity-85">
    ...
    <div class="flex justify-center shadow-lg mt-8">
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105"
                src="{{ asset('images/Voorthuizen/HouseV.png') }}" alt="Voorthuizen">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105"
                src="{{ asset('images/Olburgen/HouseO.jpg') }}" alt="Olburgen">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105"
                src="{{ asset('images/Hierden/HouseH.jpg') }}" alt="Hierden">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105"
                src="{{ asset('images/Hierden/HouseH.jpg') }}" alt="Hierden">
