...
<body class="flex flex-col min-h-screen ubuntu-medium">
    <div class="relative h-72 bg-green-800 flex items-center justify-center ">
        ...
        <h2 class="ubuntu-regular-italic absolute left-4 top-44 z-20 text-white text-2xl ">Ontsnap naar de natuur, verblijf in een Bamihuisje</h2>
    ...
    <div class="flex justify-center shadow-lg mt-8">
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105" src="{{ asset('images/Voorthuizen/HouseV.png') }}" alt="Voorthuizen">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105" src="{{ asset('images/Olburgen/HouseO.jpg') }}" alt="Olburgen">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105" src="{{ asset('images/Hierden/HouseH.jpg') }}" alt="Hierden">
        </div>
        <div class="w-72 h-60 mb-4 mx-8">
            <img class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105" src="{{ asset('images/Hierden/HouseH.jpg') }}" alt="Hierden">
        </div>
